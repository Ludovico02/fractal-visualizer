...
async function createFractalEngine(moduleArg = {}) {
...
var _calculateReferenceOrbit = Module['_calculateReferenceOrbit'] = makeInvalidEarlyAccess('_calculateReferenceOrbit');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['calculateReferenceOrbit'] != 'undefined', 'missing Wasm export: calculateReferenceOrbit');
  ...
  _calculateReferenceOrbit = Module['_calculateReferenceOrbit'] = createExportWrapper('calculateReferenceOrbit', wasmExports['calculateReferenceOrbit'], 6);
